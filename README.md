...
- Es importante señalar que el script **`FILOGENIAS.sh`** ejecuta principalmente los tres primeros pasos del proceso.
...
- **`Muscle/`**: donde encontraras el archivo **`.fasta`** con las secuencias alineadas.
